...
public class ATETSDK {
	...
	public void pay(final PayParams data){
        ...
        payRequest.addParam(PayRequest.WARESNAME, data.getProductName());
        ...
        Log.v("U8SDK","APPKRY = " + payRequest.l1l111lll1("APPKEY") + "APPID = " + 
        		this.appid + "CPID = " + 
        		this.cpid + "NOTIFYURL = " + this.payUrl + "WARESID = " + data.getProductName()
        		+ "WARESNAME = " + waresid + "EXORDERNO = " + data.getOrderID() 
        		+ "PRICE = " + data.getPrice()*100 + "QUANTITY = " + 1);
